...
class TestEventBridgePollE2E:
    ...
    def test_startup_baseline_suppresses_historical_replay(self, tmp_path, monkeypatch):
        ...
        baseline_mtime_ns = db_path.stat().st_mtime_ns
        ...
        # Advance deterministically: os.utime(path, None) can resolve to the
        # same filesystem timestamp as the baseline on fast/coarse runners.
        changed_mtime_ns = baseline_mtime_ns + 1_000_000_000
