    ...
    *,
    ...
    for row in ready_rows:
        ...
        if preflight_task is None:
            if targeted:
                requested_by_id[row["id"]].outcome = "not_found"
            else:
                _record_ready_disposition(
                    conn,
                    result,
        ...
        if not _preflight_forced_skills(
            ...
            if targeted:
                ...
                outcome.assignee = row_assignee
                outcome.detail = "forced_skill_preflight"
            else:
                _record_ready_disposition(
                    conn,
                    result,
